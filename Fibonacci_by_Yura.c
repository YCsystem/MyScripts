...
int main(void)
{
    ...
    //  =============== виводимо надпис =============== //
    printf("\n%s##################################################################################\n", RED);
    printf("#    %sMade by Yura Zosia %s<YuraZosia@gmail.com>                                    #\n", YELLOW, RED);
    ...
    while (prev_num < MAX_VALUE) // цикл триває поки результат послідовності, а точніше перостаннє число послідовності буде не більше 4000000 (4M)
    {
        ...
        //printf( "[%i] ", prev_num);    // виводимо послідовність фебоначі
    ...
    printf("%s%i%s", YELLOW, result, WHITE);
    printf("\n\n");
    printf("%sCS50 2019 LVIV\n\n", YELLOW);
